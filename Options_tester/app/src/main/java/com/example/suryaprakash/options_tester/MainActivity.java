...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView donuts , burgers;

        donuts = (ImageView) findViewById(R.id.donuts);
        burgers = (ImageView) findViewById(R.id.burgers);

        donuts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent ( MainActivity.this, RadioButtons.class );
                intent.putExtra ( "Order" , "Donut");
